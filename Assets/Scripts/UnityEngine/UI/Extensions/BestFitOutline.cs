	...
	public class BestFitOutline : Shadow
	{
		...
		public override void ModifyMesh(Mesh mesh)
		{
			if (IsActive())
			{
				...
				ApplyShadowZeroAlloc(verts, color, start, count2, x, effectDistance2.y * num);
				num2 = count;
				count = list.Count;
				...
				ApplyShadowZeroAlloc(verts2, color2, start2, count3, x2, (0f - effectDistance4.y) * num);
				num2 = count;
				count = list.Count;
				...
				ApplyShadowZeroAlloc(verts3, color3, start3, count4, x3, effectDistance6.y * num);
				num2 = count;
				count = list.Count;
				...
				ApplyShadowZeroAlloc(verts4, color4, start4, count5, x4, (0f - effectDistance8.y) * num);

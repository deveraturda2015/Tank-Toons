	...
	public class AutoCompleteComboBox : MonoBehaviour
	{
		...
		private void RedrawPanel()
		{
			...
			if (_panelItems.Count >= 1)
			{
				...
				slidingAreaRT.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, num3 - sizeDelta9.x);
			}
		}
		...
		{
			List<string> second = (from x in _panelItems
			...
			List<string> list2 = (from x in _prunedPanelItems

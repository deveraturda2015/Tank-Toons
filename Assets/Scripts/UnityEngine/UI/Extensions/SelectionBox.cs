...
namespace UnityEngine.UI.Extensions
{
	...
	public class SelectionBox : MonoBehaviour
	{
		...
		private void BeginSelection()
		{
			...
			MonoBehaviour[] array = (selectableGroup != null) ? selectableGroup : UnityEngine.Object.FindObjectsOfType<MonoBehaviour>();
		...
		{
			if (!PointIsValidAgainstSelectionMask(UnityEngine.Input.mousePosition))
			{
				return null;
			}
